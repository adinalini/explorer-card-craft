        ...
        <div className="relative z-10 h-[70vh] p-8">
          <div className="grid grid-cols-2 grid-rows-2 gap-6 h-full max-w-6xl mx-auto">
            ...
            <Button 
              ...
              className="h-full bg-[hsl(var(--homepage-button-cards))] hover:bg-[hsl(var(--homepage-button-cards))]/90 text-[hsl(var(--foreground))] text-4xl md:text-6xl font-bold rounded-3xl shadow-2xl transform transition-all duration-300 hover:scale-105 hover:shadow-neon-green animate-fade-in"
            ...
            <Button 
              ...
              onMouseLeave={() => setHoveredButton(null)}
              className="h-full bg-[hsl(var(--homepage-button-decks))] hover:bg-[hsl(var(--homepage-button-decks))]/90 text-[hsl(var(--foreground))] text-4xl md:text-6xl font-bold rounded-3xl shadow-2xl transform transition-all duration-300 hover:scale-105 animate-fade-in"
            ...
            <Button 
              ...
              onMouseLeave={() => setHoveredButton(null)}
              className="h-full bg-[hsl(var(--homepage-button-draft))] hover:bg-[hsl(var(--homepage-button-draft))]/90 text-[hsl(var(--foreground))] text-4xl md:text-6xl font-bold rounded-3xl shadow-2xl transform transition-all duration-300 hover:scale-105 hover:shadow-neon-pink animate-fade-in"
            ...
            <Button 
              ...
              onMouseLeave={() => setHoveredButton(null)}
              className="h-full bg-[hsl(var(--homepage-button-random))] hover:bg-[hsl(var(--homepage-button-random))]/90 text-[hsl(var(--foreground))] text-4xl md:text-6xl font-bold rounded-3xl shadow-2xl transform transition-all duration-300 hover:scale-105 animate-fade-in flex items-center justify-center"
